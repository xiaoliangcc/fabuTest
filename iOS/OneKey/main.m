...
void  loading_cffi_backend() {
    ...
    NSString *fileStr = [NSString stringWithFormat:@"%@/Library/Application Support/so.onekey.one.OneKey/app/OneKey/CFFI/_cffi_backend.framework/_cffi_backend.cpython-38-darwin.so", [[NSBundle mainBundle] resourcePath]];
